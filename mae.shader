...
Shader "!luka/mae"
{
	...
	Properties
	{
		...
		//warning
		[Space(40)]
		[Header(henlo. luka mae v12. by lukasong.)]
		...
		[Enum(Disabled, 0, Enabled, 1)] _AllowSmartFalloff("Allow Falloff", Float) = 1
		...
		[Enum(Everywhere, 0, Mirrors Only, 1, World Only, 2)] _MirrorRendering ("Mirror Rendering:", Float) = 0
		_PlatformAdjust("Platform Adjust", Range(0, 2)) = 1
		[Enum(Everywhere, 0, Virtual Reality Only, 1, Desktop Mode Only, 2)] _PlatformRendering ("Platform Rendering:", Float) = 0
		_VRAdjust("VR Adjust", Range(0, 2)) = 1
		//[Enum(Everywhere (In and Out of Cameras), In VR Cameras Only, 1, Out of Cameras Only, 2)] _CameraRendering ("VR Camera Rendering:", Float) = 0
		//_CameraAdjust("Camera Adjust", Range(0, 2)) = 1
		...
		//blink
		[Enum(Cinematic, 0, Frame, 1, Animu, 2)] _BlinkMethod ("Blink Method", Float) = 0          
		_AnimeMap ("Guideline Noise", 2D) = "white" {}
		_AnimeRadius("Line Radius", Range(1.75, 0.5)) = 1.1      
		_AnimeSpeed ("Line Speed", Float) = 0
		_AnimeSeed ("Line Seed", Float) = 0 
		_AnimeColor ("Line Color", Color) = (0, 0, 0, 1) 
		[Enum(Box, 0, Circle, 1, Mask, 2)] _BorderShape ("Border Shape", Float) = 0
		_BorderMap ("Guideline Mask", 2D) = "white" {}
		_BorderStrength ("Border Strength", Range(0, 1)) = 0
		_BorderColor ("Border Color", Color) = (0, 0, 0, 1) 
		[Enum(Color, 0, Effects, 1)] _BorderMethod ("Border Method", Float) = 0          
		[Enum(Border, 0, Center, 1)] _BorderEffect ("Effect Layer", Float) = 0
		[Enum(Vertical, 1, Horizontal, 2, UFO, 3)] _BlinkMode ("Blink Mode", Float) = 1
		[Enum(Over Overlays, 1, Under Overlays, 0)] _ForceBlink ("Blink Over Img Overlay?", Float) = 1
		...
		[Enum(Disabled, 0, Enabled, 1)] _BlinkRainbowX ("Allow Horizontal", Float) = 0
		[Enum(Disabled, 0, Enabled, 1)] _BlinkRainbowY("Allow Vertical", Float) = 0  
		...
		_BorderImageX("Image X Size", Range(-5, 5)) = -2
		_BorderImageY("Image Y Size", Range(-5, 5)) = -2     
		_BorderImageXShift ("Image X Shift", Range(-2, 2)) = 0
		_BorderImageYShift ("Image Y Shift", Range(-2, 2)) = 0
		_ToggleFlash ("Camera Flash", Range(0, 1)) = 0                 
		_FlashLeft ("Flash Left", Range(1.5, 1)) = 1.5
		_FlashRight ("Flash Right", Range(1.5, 1)) = 1.5
		_FlashTop ("Flash Top", Range(1.5, 1)) = 1.5
		_FlashBot ("Flash Bottom", Range(1.5, 1)) = 1.5
		_FlashColor ("Flash Color", Color) = (1, 1, 1, 1)                     
		_FlashRainbow("Allow Rainbow", Range(0, 1)) = 0
		[Enum(Disabled, 0, Enabled, 1)] _FlashRainbowX("Allow Horizontal", Float) = 0
		[Enum(Disabled, 0, Enabled, 1)] _FlashRainbowY("Allow Vertical", Float) = 0
		_FlashRainbowHue("Hue", Range(0, 1.5)) = 0.1
		_FlashRainbowSat("Saturation", Range(0, 3)) = 1 
		_FlashRainbowLight("Lightness", Range(0.1, 3)) = 1
		_FlashRainbowTime("Time", Range(0, 3)) = 0.8
	
		//blur           
		[Enum(Disabled, 0, Enabled, 1)] _ToggleNBlur ("Allow Blur", Float) = 0
		[Enum(Blur, 0, Radial, 1, Bloom, 2, Motion, 3)] _NBlurMethod ("Blur Method", Float) = 0
		...
		//bloom        
		[Enum(Disabled, 0, Enabled, 1)] _RBloomToggle("Allow Bloom", Float) = 0
		...
		[Enum(Blocks, 0, Artifacts, 1)] _BGMethod ("Glitch Style", Float) = 0
		...
		_ArtPower ("Artifact Strength", Range(1, 0.001)) = 0                           
		_ArtSize ("Artifact Size", Range(0, 100)) = 0
		_ArtDis ("Artifact Displacement", Range(0, 0.5)) = 0
		...
		//motion freeze
		[Toggle(_)] _ToggleRFreeze ("Freeze Red Channel?", Float) = 0
		[Toggle(_)] _ToggleGFreeze("Freeze Green Channel?", Float) = 0  
		[Toggle(_)] _ToggleBFreeze("Freeze Green Channel?", Float) = 0                 
		_FreezeThreshX ("Freeze X Threshold", Range(0, 1)) = 0
		_FreezeThreshY ("Freeze Y Threshold", Range(0, 1)) = 0         

		//motion blur
		[Enum(Screen, 0, RGB, 1)] _MBMethod ("Motion Blur Method", Float) = 0
		[IntRange] _MotionBlurPower ("Motion Blur Strength", Range(0, 16)) = 0              
		_MotionBlurVR ("Adjust VR Strength", Range(1, 0.1)) = 1    
		[Enum(Disabled, 0, Enabled, 1)] _MBDualPass ("Dual Pass M. Blur?", Float) = 0 
		_MBX ("X Shift", Range(-0.005, 0.005)) = 0       
		_MBY ("Y Shift", Range(-0.005, 0.005)) = 0  
		[Enum(Disabled, 0, Enabled, 1)] _MBToggleED("Allow Outline", Float) = 0 
		_MBEDLighting ("Lighting Balance", Range(1, 0)) = 0 
		_MBEDColor("MotionBlur Outline Color", Color) = (1, 1, 1, 1)
		_MBEDTolerance("MotionBlur Outline Tolerance", Range(0, 5)) = 0.2 
		_MBEDTrans("MotionBlur Outline Transparency", Range(0, 1)) = 1  
		_MBEDWidth("MotionBlur Outline Width", Range(1, 10)) = 1
		[Enum(Disabled, 0, Enabled, 1)] _MBDistortionToggle("Distortion", Float) = 0  
		_MBDistortionMap("Distortion Map", 2D) = "white" {}     
		_MBDistortionX("X Power", Range(-1, 1)) = 0
		_MBDistortionY("Y Power", Range(-1, 1)) = 0 
		_MBDistortionXSpeed("X Speed", Range(0, 5)) = 0
		_MBDistortionYSpeed("Y Speed", Range(0, 5)) = 0
		_MBGreen ("Green Push", Range(-0.01, 0.01)) = 0.005
		_MBBlue ("Blue Push", Range(-0.02, 0.02)) = 0.01
		[Enum(Apply, 0, Return, 1)] _MBForce ("Force Frame Data", Float) = 0

		//motion glitch
		[Toggle(_)] _MotGlitch ("Motion Glitch Strength", Float) = 0
		[Enum(Blocky, 0, RGB Blocky, 1, Artifacts, 2, RGB Artifacts, 3, Datamosh, 4)]_MotGlitchMode ("M. Glitch Mode:", Float) = 0
		//_MotGlitchMap("M. Glitch Map", 2D) = "white" {}
		_MotArtPower("M. Artifact Strength", Range(1, 0.001)) = 0
		_MotArtSize("M. Artifact Size", Range(0, 100)) = 0
		//_MotArtDis("M. Artifact Displacement", Range(0, 0.5)) = 0
		_MotBlockyPower("M. Blocky Power", Range(0, 2)) = 0.1
		...
		_OvClipOne ("Alpha Clip", Range(0, 1)) = 0
		_OvClipTwo ("Alpha Clip", Range(0, 1)) = 0
		_OvClipThree ("Alpha Clip", Range(0, 1)) = 0
		_OvColOne ("Overlay Color", Color) = (1, 1, 1, 1)
		_OvColTwo ("Overlay Color", Color) = (1, 1, 1, 1)
		_OvColThree ("Overlay Color", Color) = (1, 1, 1, 1)

		//gif overlay
		[Toggle(_)] _ToggleGifOverlay ("Allow Gif Overlay", Float) = 0
		[Enum(Overlay, 0, Distortion, 1)] _GifMethod ("Gif Method", Float) = 0
		...
		_GifScrub ("Scrub", Range(0, 10)) = 0
		_GifClip ("Alpha Clip", Range(0, 1)) = 0
		_GifColor ("Gif Color", Color) = (1, 1, 1, 1)

		//gif distortion
		_GDDistortionX("X Power", Range(-1, 1)) = 0
		_GDDistortionY("Y Power", Range(-1, 1)) = 0
		_GDDistortionXSpeed("X Speed", Range(0, 5)) = 0
		_GDDistortionYSpeed("Y Speed", Range(0, 5)) = 0

		//gravity
		[Toggle(_)] _ToggleGravity ("Allow Gravity", Range(0.5, 1.5)) = 0
		[Enum(Extrude, 0, Implode, 1)] _GravityMethod ("Gravity Method:", Float) = 0
		_GravityRadius  ("Gravity Radius", Range(0, 2)) = 1    
		...
		//radial
		[Enum(Disabled, 0, Enabled, 1)] _ToggleRadialBlur ("Allow Radial Blur", Float) = 0 
		...
		[Enum(Disabled, 0, Enabled, 1)] _RBToggleED("Allow Outline", Float) = 0
		...
		[Enum(Radial Zoom, 3, Radial, 0, Projection, 1, Rotation, 2, Radial Space Rays, 4, Projection Space Rays, 5)] _RBMode ("Radial Projection Mode", Float) = 3 
		[Enum(Off, 0, On, 1)] _RBInverse ("Inverse Blur?", Float) = 0
		_RBColorTest ("Color Test", Color) = (0.8, 0.8, 0.8, 1)  
		_RBColoring ("Color", Color) = (1, 1, 1, 1)   
		_RBBW ("Black and White", Range(0, 1)) = 0
		_RBDarkness ("Darkness", Range(0, 1)) = 0
		_RBExposure ("Exposure", Range(0, 1)) = 0 
		[Enum(Disabled, 0, Enabled, 1)] _RBColoringToggle ("Coloring", Float) = 0 
		_RBRadius ("Radius", Range(0.5, 1.5)) = 1
		[IntRange] _RBItterations("Radial Blur Itterations", Range(1, 64)) = 16 
		[Enum(OFF, 0, ON, 1)] _RBEDOnly ("Outli ne Only?", Float ) = 0
		_RBEDBalance ("Radial Balance Lighting", Range(0.1, 75)) = 1
		...
		[Enum(Disabled, 0, Enabled, 1)] _RBDistortionToggle ("Distortion", Float) = 0
		_RBDistortionMap("Distortion Map", 2D) = "white" {}
		_RBDistortionX("X Power", Range(-1, 1)) = 0
		_RBDistortionY("Y Power", Range(-1, 1)) = 0
		_RBDistortionXSpeed("X Speed", Range(0, 5)) = 0
		_RBDistortionYSpeed("Y Speed", Range(0, 5)) = 0     
		//[Enum(Disabled, 0, Enabled, 1)] _RBJitter ("Remove Banding", Float) = 0                     
		...
		//recolor + rainbow
		[Enum(Rainbow Overlay, 0, Hue Shift, 1)] _HueMethod ("Hue Method", Float) = 0           
		[Enum(Screen Colors, 0, Depth Level, 1, Circles, 2)] _RecolorMethod ("Recolor Method", Float) = 0
		[Enum(Disabled, 0, Enabled, 1)] _ToggleRecolor ("Allow Hue Shift", Range(0, 1)) = 0 
		[Enum(Off, 0, On, 1)] _ToggleRecolorAnimate ("Rainbow?", Float) = 0
		...
		[Enum(Off, 0, On, 1)] _ToggleHSVRainbowX("Allow Horizontal", Float) = 0                 
		[Enum(Off, 0, On, 1)] _ToggleHSVRainbowY("Allow Vertical", Float) = 0
		...
		[Enum(Disabled, 0, Enabled, 1)] _HSVToggleDistortion("Allow Distortion", Float) = 0
		_HSVDistortionMap("Distortion Map", 2D) = "white" {}
		_HSVDistortionX("X Power", Range(0, 1)) = 0
		_HSVDistortionY("Y Power", Range(0, 1)) = 0
		_HSVDistortionXSpeed("X Speed", Range(0, 5)) = 0     
		_HSVDistortionYSpeed("Y Speed", Range(0, 5)) = 0

		//rgb  
		[Enum(Disabled, 0, Enabled, 1)] _ToggleRGB ("Allow CA?", Float) = 0
		[Enum(RGB, 0, HSB, 1, Negativity, 2)] _CAMode ("CA Mode", Float) = 0
		[Enum(Simple and Color Method, 0, Sampled, 1, Rotating, 2, RGB Cells, 3)] _CAStyle("CA Style", Float) = 1
		...
		[Enum(Disabled, 0, Enabled, 1)] _ToggleAutoanimate ("Animate RGB?", Float ) = 0
		...
		_RGBCells ("RGB Cells", Range(100, 3.5)) = 15
		...
		[IntRange] _CSCopies ("Smear", Range(1, 16)) = 1 
		...
		_SwirlSpeed ("Swirl Speed", Range(-2, 2)) = 0  
		...
		//screenfreeze
		[Toggle(_)] _ToggleFreeze ("Freeze Screen", Float) = 0
		...
		_VHSXDisplacement ("Line Count", Range(1, 100)) = 30     
		_VHSYDisplacement ("Line Speed", Range(0, 0.5)) = 0
		...
		_VigX ("Vignette Power", Range(0, 100)) = 0
		...
		_VigToggleHSVRainbow("Allow Rainbow", Range(0, 1)) = 0
		[Enum(Off, 0, On, 1)] _VigToggleHSVRainbowX("Allow Horizontal", Float) = 0
		[Enum(Off, 0, On, 1)] _VigToggleHSVRainbowY("Allow Vertical", Float) = 0
		_VigHSVRainbowHue("Hue", Range(0, 1.5)) = 0.1
		_VigHSVRainbowSat("Saturation", Range(0, 3)) = 1
		_VigHSVRainbowLight("Lightness", Range(0.1, 3)) = 1
		_VigHSVRainbowTime("Time", Range(0, 3)) = 0.8
		_VigFlicker ("Flicker", Range(0, 20)) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma target 5.0
			#include "Resources/CGInc/LukaHelper.cginc"
			#include "Resources/CGInc/LukaFrontPass.cginc"
			ENDCG
		}
		...
		Pass
		{
			...
			#pragma target 5.0
			#include "Resources/CGInc/LukaHelper.cginc"
			#include "Resources/CGInc/LukaBackPass.cginc"
			ENDCG
		}
