...
public class LukaSE11 : ShaderGUI
{
    ...
    #region variables
    //Variables 
    static String versionNumber = "12";
    static String fileNumber = "12";
    static String shaderVersionNumber = "rl"; //rl = release //unrl = unreleased //be = beta
    static String shaderUpdate = "October 13, 2019";
    ...
    static String mirrorDirectory = "Hidden/" + shaderDirectory + "/mirror";
    static String xpDirectory = "Hidden/" + shaderDirectory + "/xp";
    ...
    static String gifSrc;
    static String gifSave;
    static String gifName;
    static String gifColumns;
    static String gameobjQuery;
    static String animFileIn;
    static String animFileOut;
    public static String haibomo = null;
    public static bool haitime;
    ...
    static bool installMirror;
    static bool installFreeze;
    static bool installXp;
    static bool installLimit;
    static bool mirrorOn;
    static bool freezeOn;
    static bool xpOn;
    static Boolean installClick;
    static float tabSize = 28.0f;
    static String renderImage = "";
    static String blurImage = "";
    static String borderImage = "";
    static String chromaticImage = "";
    static String coloringImage = "";
    static String colorreplacementImage = "";
    static String deepfryImage = "";
    static String distortionImage = "";
    static String filtersImage = "";
    static String fogImage = "";
    static String framedataImage = "";
    static String glitchesImage = "";
    static String outlinesImage = "";
    static String overlaysImage = "";
    static String rainbowImage = "";
    static String shakeImage = "";
    static String screencontrolImage = "";
    static String zoomImage = "";
    static String miscImage = "";
    static String toolsImage = "";
    static String helpImage = "";
    static String settingsImage = "";
    //Properties    
    ...
    static Boolean displayInstallation;
    //presets
    ...
    static string[] themeOption = new string[]
    {
                "Default", "Nyan", "Vapor"
    };
    //render 
    ...
    MaterialProperty _BlinkMethod;
    MaterialProperty _AnimeMap;
    MaterialProperty _AnimeRadius;
    MaterialProperty _AnimeSpeed;
    MaterialProperty _AnimeSeed;
    MaterialProperty _AnimeColor;
    MaterialProperty _BorderShape;
    MaterialProperty _BorderMap;
    MaterialProperty _BorderStrength;
    MaterialProperty _BorderColor;
    MaterialProperty _BorderEffect;
    MaterialProperty _BorderMethod;
    MaterialProperty _BorderImageX;
    MaterialProperty _BorderImageY;
    MaterialProperty _BorderImageXShift;
    MaterialProperty _BorderImageYShift;
    MaterialProperty _ToggleFlash;
    MaterialProperty _FlashLeft;
    MaterialProperty _FlashRight;
    MaterialProperty _FlashTop;
    MaterialProperty _FlashBot;
    MaterialProperty _FlashColor;
    MaterialProperty _FlashRainbow;
    MaterialProperty _FlashRainbowX;
    MaterialProperty _FlashRainbowY;
    MaterialProperty _FlashRainbowHue;
    MaterialProperty _FlashRainbowSat;
    MaterialProperty _FlashRainbowLight;
    MaterialProperty _FlashRainbowTime;
    //new blur
    MaterialProperty _NBlurMethod;
    ...
    //gravity
    MaterialProperty _ToggleGravity;
    MaterialProperty _GravityMethod;
    MaterialProperty _GravityRadius;
    //rgb glitch
    ...
    MaterialProperty _ArtSize;
    MaterialProperty _ArtPower;
    MaterialProperty _ArtDis;
    MaterialProperty _MBForce;
    ...
    //screenfreeze
    MaterialProperty _ToggleFreeze;
    //other frame data things
    MaterialProperty _ToggleRFreeze;
    MaterialProperty _ToggleGFreeze;
    MaterialProperty _ToggleBFreeze;
    MaterialProperty _FreezeThreshX;
    MaterialProperty _FreezeThreshY;
    MaterialProperty _MotionBlurPower;
    MaterialProperty _MotionBlurVR;
    MaterialProperty _MBToggleED;
    MaterialProperty _MBEDColor;
    MaterialProperty _MBEDTolerance;
    MaterialProperty _MBEDTrans;
    MaterialProperty _MBEDWidth;
    MaterialProperty _MBDistortionToggle;
    MaterialProperty _MBDistortionMap;
    MaterialProperty _MBDistortionX;
    MaterialProperty _MBDistortionY;
    MaterialProperty _MBDistortionXSpeed;
    MaterialProperty _MBDistortionYSpeed;
    MaterialProperty _MBDither;
    MaterialProperty _MBDitherSpeed;
    MaterialProperty _MBEDLighting;
    MaterialProperty _MBMethod;
    MaterialProperty _MBX;
    MaterialProperty _MBY;
    MaterialProperty _MBDualPass;
    MaterialProperty _MBGreen;
    MaterialProperty _MBBlue;
    MaterialProperty _MotGlitch;
    MaterialProperty _MotGlitchMode;
    MaterialProperty _MotArtPower;
    MaterialProperty _MotArtSize;
    MaterialProperty _MotBlockyPower;
    //overlay 
    ...
    MaterialProperty _OvClipOne;
    MaterialProperty _OvClipTwo;
    MaterialProperty _OvClipThree;
    MaterialProperty _OvColOne;
    MaterialProperty _OvColTwo;
    MaterialProperty _OvColThree;
    ...
    MaterialProperty _GifScrub;
    MaterialProperty _GifClip;
    MaterialProperty _GifMethod;
    MaterialProperty _GifColor;
    MaterialProperty _GDDistortionX;
    MaterialProperty _GDDistortionY;
    MaterialProperty _GDDistortionXSpeed;
    MaterialProperty _GDDistortionYSpeed;
    ...
    MaterialProperty _RBRadius;
    MaterialProperty _RBColorTest;
    MaterialProperty _RBColoring;
    MaterialProperty _RBBW;
    MaterialProperty _RBDarkness;
    MaterialProperty _RBExposure;
    MaterialProperty _RBDistortionMap;
    MaterialProperty _RBDistortionX;
    MaterialProperty _RBDistortionY;
    MaterialProperty _RBDistortionXSpeed;
    MaterialProperty _RBDistortionYSpeed;
    MaterialProperty _RBColoringToggle;
    MaterialProperty _RBDistortionToggle;
    MaterialProperty _RBInverse;
    //MaterialProperty _RBJitter;
    //ramp
    ...
    MaterialProperty _RecolorMethod;
    MaterialProperty _HueMethod;
    //rgb
    ...
    MaterialProperty _HSVToggleDistortion;
    MaterialProperty _HSVDistortionX;
    MaterialProperty _HSVDistortionY;
    MaterialProperty _HSVDistortionXSpeed;
    MaterialProperty _HSVDistortionYSpeed;
    MaterialProperty _HSVDistortionMap;
    //saturation
    ...
    MaterialProperty _VigToggleHSVRainbow;
    MaterialProperty _VigToggleHSVRainbowX;
    MaterialProperty _VigToggleHSVRainbowY;
    MaterialProperty _VigHSVRainbowHue;
    MaterialProperty _VigHSVRainbowSat;
    MaterialProperty _VigHSVRainbowLight;
    MaterialProperty _VigHSVRainbowTime;
    MaterialProperty _VigFlicker;
    //visualizer
    ...
    //render settings
    MaterialProperty _MirrorRendering;
    MaterialProperty _PlatformRendering;
    MaterialProperty _PlatformAdjust;
    //gui settings
    ...
    static bool radialColorClick;
    static bool radialDistortionClick;
    ...
    static bool stencilClick;
    static bool newtabOverlaysClick;
    static bool newtabFiltersClick;
    static bool newtabScreenClick;
    static bool newtabColorReplacementClick;
    static bool newtabMiscClick;
    static bool framedataClick;
    static bool freezeglitchClick;
    static bool motionClick;
    static bool motionGlitchClick;
    //other clicks
    ...
    //experimental clicks
    static bool experimentalClick;
    static bool screenfreezeClick;
    static bool xpClick;
    static bool mirrorhideClick;
    static bool limitbreakClick;
    //convert
    static bool animConvertClick;
    //help sections
    ...
    //thanks to Mochie#8794 for the public shader GUI heper that helped me with the textured foldout tabs c:
    ...
    private void findProperty(MaterialProperty[] properties)
    {
        ...
        _Stencil = ShaderGUI.FindProperty("_Stencil", properties);
        _ReadMask = ShaderGUI.FindProperty("_ReadMask", properties);
        _WriteMask = ShaderGUI.FindProperty("_WriteMask", properties);
        _StencilComp = ShaderGUI.FindProperty("_StencilComp", properties);
        _StencilOp = ShaderGUI.FindProperty("_StencilOp", properties);
        _StencilFail = ShaderGUI.FindProperty("_StencilFail", properties);
        _StencilZFail = ShaderGUI.FindProperty("_StencilZFail", properties);
        _MirrorRendering = ShaderGUI.FindProperty("_MirrorRendering", properties);
        _PlatformRendering = ShaderGUI.FindProperty("_PlatformRendering", properties);
        _PlatformAdjust = ShaderGUI.FindProperty("_PlatformAdjust", properties);
        _BlendDst = ShaderGUI.FindProperty("_BlendDst", properties);
        _BlendSrc = ShaderGUI.FindProperty("_BlendSrc", properties);
        ...
        _BlinkMethod = ShaderGUI.FindProperty("_BlinkMethod", properties);
        _AnimeMap = ShaderGUI.FindProperty("_AnimeMap", properties);
        _AnimeRadius = ShaderGUI.FindProperty("_AnimeRadius", properties);
        _AnimeSpeed = ShaderGUI.FindProperty("_AnimeSpeed", properties);
        _AnimeSeed = ShaderGUI.FindProperty("_AnimeSeed", properties);
        _AnimeColor = ShaderGUI.FindProperty("_AnimeColor", properties);
        _BorderShape = ShaderGUI.FindProperty("_BorderShape", properties);
        _BorderMap = ShaderGUI.FindProperty("_BorderMap", properties);
        _BorderStrength = ShaderGUI.FindProperty("_BorderStrength", properties);
        _BorderColor = ShaderGUI.FindProperty("_BorderColor", properties);
        _BorderMethod = ShaderGUI.FindProperty("_BorderMethod", properties);
        _BorderEffect = ShaderGUI.FindProperty("_BorderEffect", properties);
        _BorderImageX = ShaderGUI.FindProperty("_BorderImageX", properties);
        _BorderImageY = ShaderGUI.FindProperty("_BorderImageY", properties);
        _BorderImageXShift = ShaderGUI.FindProperty("_BorderImageXShift", properties);
        _BorderImageYShift = ShaderGUI.FindProperty("_BorderImageYShift", properties);
        _ToggleFlash = ShaderGUI.FindProperty("_ToggleFlash", properties);
        _FlashLeft = ShaderGUI.FindProperty("_FlashLeft", properties);
        _FlashRight = ShaderGUI.FindProperty("_FlashRight", properties);
        _FlashTop = ShaderGUI.FindProperty("_FlashTop", properties);
        _FlashBot = ShaderGUI.FindProperty("_FlashBot", properties);
        _FlashColor = ShaderGUI.FindProperty("_FlashColor", properties);
        _FlashRainbow = ShaderGUI.FindProperty("_FlashRainbow", properties);
        _FlashRainbowX = ShaderGUI.FindProperty("_FlashRainbowX", properties);
        _FlashRainbowY = ShaderGUI.FindProperty("_FlashRainbowY", properties);
        _FlashRainbowHue = ShaderGUI.FindProperty("_FlashRainbowHue", properties);
        _FlashRainbowSat = ShaderGUI.FindProperty("_FlashRainbowSat", properties);
        _FlashRainbowLight = ShaderGUI.FindProperty("_FlashRainbowLight", properties);
        _FlashRainbowTime = ShaderGUI.FindProperty("_FlashRainbowTime", properties);
        ...
        //New blur settings
        _NBlurMethod = ShaderGUI.FindProperty("_NBlurMethod", properties);
        ...
        //Gravity settings
        _ToggleGravity = ShaderGUI.FindProperty("_ToggleGravity", properties);
        _GravityMethod = ShaderGUI.FindProperty("_GravityMethod", properties);
        _GravityRadius = ShaderGUI.FindProperty("_GravityRadius", properties);
        ...
        _BGMethod = ShaderGUI.FindProperty("_BGMethod", properties);
        ...
        _ArtSize = ShaderGUI.FindProperty("_ArtSize", properties);
        _ArtDis = ShaderGUI.FindProperty("_ArtDis", properties);
        _ArtPower = ShaderGUI.FindProperty("_ArtPower", properties);
        _MBForce = ShaderGUI.FindProperty("_MBForce", properties);
        ...
        //Screenfreeze settings
        _ToggleFreeze = ShaderGUI.FindProperty("_ToggleFreeze", properties);
        _ToggleRFreeze = ShaderGUI.FindProperty("_ToggleRFreeze", properties);
        _ToggleGFreeze = ShaderGUI.FindProperty("_ToggleGFreeze", properties);
        _ToggleBFreeze = ShaderGUI.FindProperty("_ToggleBFreeze", properties);
        _FreezeThreshX = ShaderGUI.FindProperty("_FreezeThreshX", properties);
        _FreezeThreshY = ShaderGUI.FindProperty("_FreezeThreshY", properties);
        _MotionBlurPower = ShaderGUI.FindProperty("_MotionBlurPower", properties);
        _MotionBlurVR = ShaderGUI.FindProperty("_MotionBlurVR", properties);      
        _MBToggleED = ShaderGUI.FindProperty("_MBToggleED", properties);
        _MBEDColor = ShaderGUI.FindProperty("_MBEDColor", properties);
        _MBEDTolerance = ShaderGUI.FindProperty("_MBEDTolerance", properties);
        _MBEDTrans = ShaderGUI.FindProperty("_MBEDTrans", properties);
        _MBEDWidth = ShaderGUI.FindProperty("_MBEDWidth", properties);
        _MBDistortionToggle = ShaderGUI.FindProperty("_MBDistortionToggle", properties);
        _MBDistortionMap = ShaderGUI.FindProperty("_MBDistortionMap", properties);
        _MBDistortionX = ShaderGUI.FindProperty("_MBDistortionX", properties);
        _MBDistortionY = ShaderGUI.FindProperty("_MBDistortionY", properties);
        _MBDistortionXSpeed = ShaderGUI.FindProperty("_MBDistortionXSpeed", properties);
        _MBDistortionYSpeed = ShaderGUI.FindProperty("_MBDistortionYSpeed", properties);
        _MBEDLighting = ShaderGUI.FindProperty("_MBEDLighting", properties);
        _MBMethod = ShaderGUI.FindProperty("_MBMethod", properties);
        _MBX = ShaderGUI.FindProperty("_MBX", properties);
        _MBY = ShaderGUI.FindProperty("_MBY", properties);
        _MBDualPass = ShaderGUI.FindProperty("_MBDualPass", properties);
        _MBGreen = ShaderGUI.FindProperty("_MBGreen", properties);
        _MBBlue = ShaderGUI.FindProperty("_MBBlue", properties);
        _MotGlitch = ShaderGUI.FindProperty("_MotGlitch", properties);
        _MotGlitchMode = ShaderGUI.FindProperty("_MotGlitchMode", properties);
        _MotArtPower = ShaderGUI.FindProperty("_MotArtPower", properties);
        _MotArtSize = ShaderGUI.FindProperty("_MotArtSize", properties); 
        _MotBlockyPower = ShaderGUI.FindProperty("_MotBlockyPower", properties);
        ...
        _OvClipOne = ShaderGUI.FindProperty("_OvClipOne", properties);
        _OvClipTwo = ShaderGUI.FindProperty("_OvClipTwo", properties);
        _OvClipThree = ShaderGUI.FindProperty("_OvClipThree", properties);
        _OvColOne = ShaderGUI.FindProperty("_OvColOne", properties);
        _OvColTwo = ShaderGUI.FindProperty("_OvColTwo", properties);
        _OvColThree = ShaderGUI.FindProperty("_OvColThree", properties);
        ...
        _GifClip = ShaderGUI.FindProperty("_GifClip", properties);
        ...
        _GifScrub = ShaderGUI.FindProperty("_GifScrub", properties);
        _GifMethod = ShaderGUI.FindProperty("_GifMethod", properties);
        _GifColor = ShaderGUI.FindProperty("_GifColor", properties);
        _GDDistortionX = ShaderGUI.FindProperty("_GDDistortionX", properties);
        _GDDistortionY = ShaderGUI.FindProperty("_GDDistortionY", properties);
        _GDDistortionXSpeed = ShaderGUI.FindProperty("_GDDistortionXSpeed", properties);
        _GDDistortionYSpeed = ShaderGUI.FindProperty("_GDDistortionYSpeed", properties);
        ...
        _HSVToggleDistortion = ShaderGUI.FindProperty("_HSVToggleDistortion", properties);
        _HSVDistortionX = ShaderGUI.FindProperty("_HSVDistortionX", properties);
        _HSVDistortionY = ShaderGUI.FindProperty("_HSVDistortionY", properties);
        _HSVDistortionXSpeed = ShaderGUI.FindProperty("_HSVDistortionXSpeed", properties);
        _HSVDistortionYSpeed = ShaderGUI.FindProperty("_HSVDistortionYSpeed", properties);
        _HSVDistortionMap = ShaderGUI.FindProperty("_HSVDistortionMap", properties);
        ...
        _RBRadius = ShaderGUI.FindProperty("_RBRadius", properties);
        _RBColorTest = ShaderGUI.FindProperty("_RBColorTest", properties);
        _RBColoring = ShaderGUI.FindProperty("_RBColoring", properties);
        _RBBW = ShaderGUI.FindProperty("_RBBW", properties);
        _RBDarkness = ShaderGUI.FindProperty("_RBDarkness", properties);
        _RBExposure = ShaderGUI.FindProperty("_RBExposure", properties);
        _RBDistortionMap = ShaderGUI.FindProperty("_RBDistortionMap", properties);
        _RBDistortionX = ShaderGUI.FindProperty("_RBDistortionX", properties);
        _RBDistortionY = ShaderGUI.FindProperty("_RBDistortionY", properties);
        _RBDistortionXSpeed = ShaderGUI.FindProperty("_RBDistortionXSpeed", properties);
        _RBDistortionYSpeed = ShaderGUI.FindProperty("_RBDistortionYSpeed", properties);
        _RBColoringToggle = ShaderGUI.FindProperty("_RBColoringToggle", properties);
        _RBDistortionToggle = ShaderGUI.FindProperty("_RBDistortionToggle", properties);
        _RBInverse = ShaderGUI.FindProperty("_RBInverse", properties);
        //_RBJitter = ShaderGUI.FindProperty("_RBJitter", properties);
        ...
        _HueMethod = ShaderGUI.FindProperty("_HueMethod", properties);
        _RecolorMethod = ShaderGUI.FindProperty("_RecolorMethod", properties);
        ...
        _RGBCells = ShaderGUI.FindProperty("_RGBCells", properties);
        ...
        _SwirlSpeed = ShaderGUI.FindProperty("_SwirlSpeed", properties);
        ...
        _VigToggleHSVRainbow = ShaderGUI.FindProperty("_VigToggleHSVRainbow", properties);
        _VigToggleHSVRainbowX = ShaderGUI.FindProperty("_VigToggleHSVRainbowX", properties);
        _VigToggleHSVRainbowY = ShaderGUI.FindProperty("_VigToggleHSVRainbowY", properties);
        _VigHSVRainbowHue = ShaderGUI.FindProperty("_VigHSVRainbowHue", properties);
        _VigHSVRainbowSat = ShaderGUI.FindProperty("_VigHSVRainbowSat", properties);
        _VigHSVRainbowLight = ShaderGUI.FindProperty("_VigHSVRainbowLight", properties);
        _VigHSVRainbowTime = ShaderGUI.FindProperty("_VigHSVRainbowTime", properties);
        _VigFlicker = ShaderGUI.FindProperty("_VigFlicker", properties);
    ...
    private void defineStyles()
    {
        ...
        //Fake property but centered lol style
        fakePropertyCenterStyle = new GUIStyle();
        fakePropertyCenterStyle.richText = true;
        fakePropertyCenterStyle.fontSize = 11;
        fakePropertyCenterStyle.alignment = TextAnchor.MiddleCenter;
    ...
    private static class propStyles
    {
        ...
        public static GUIContent PlatformCheck = new GUIContent("Platform Specific", "");
        ...
        public static GUIContent Blink = new GUIContent("Border", "Adds bars that close in on the screen.");
        ...
        public static GUIContent Experimental = new GUIContent("Experimental", "Experimental effects will go here..");
        ...
        public static GUIContent ScanlinePushStyle = new GUIContent("Scanline Distort", "How much the scanline should distort the screen.");
    ...
    private void currentlyToggled()
    {
        ...
        {
            propStyles.DropdownRender.text = "Rendering (Opacity: " + _OverallOpacity.floatValue + ")";
        }
        else
        {
            propStyles.DropdownRender.text = "Rendering";
        }


        if(!(_PlatformRendering.floatValue == 0) || !(_MirrorRendering.floatValue == 0))
        {
            propStyles.PlatformCheck.text = "Platform Specific " + addonCheck;
        }
        else
        {
            propStyles.PlatformCheck.text = "Platform Specific";
        }
        ...
        {
            propStyles.RenderAtMe.text = "Angular Falloff" + addonCheck;
            ntRenderAtMe = true;
        }
        else
        {
            propStyles.RenderAtMe.text = "Angular Falloff";
            ntRenderAtMe = false;
        }
        ...
        //Screenfreeze
        if (_ToggleFreeze.floatValue == 1)
        {
            propStyles.Screenfreeze.text = "Screenfreeze" + addonCheck;
            ntScreenfreeze = true;
        }
        else
        {
            propStyles.Screenfreeze.text = "Screenfreeze";
            ntScreenfreeze = false;
        }
        ...
        {
            propStyles.Screenspace.text = "Screensquish" + addonCheck;
            ntScreenspace = true;
        }
        else
        {
            propStyles.Screenspace.text = "Screensquish";
            ntScreenspace = false;
        }
        ...
        //Blink
        if ((_BlinkStrength.floatValue > 0 && _BlinkMethod.floatValue == 0)|| (_AnimeRadius.floatValue < 1.75 &&  _BlinkMethod.floatValue == 2) || (_BorderStrength.floatValue > 0 && _BlinkMethod.floatValue == 1) || (_BlinkMethod.floatValue == 0 && _ToggleFlash.floatValue > 0))
        {
            propStyles.Blink.text = "Border" + addonCheck;
            ntBlink = true;
        }
        else
        {
            propStyles.Blink.text = "Border";
            ntBlink = false;
        }
        ...
        {
            propStyles.Inceptions.text = "Inception" + addonCheck;
            ntInception = true;
        }
        else
        {
            propStyles.Inceptions.text = "Inception";
            ntInception = false;
        }
        ...
        //HSV Rainbow
        if (_ToggleHSVRainbow.floatValue > 0 || ntRecolor)
        {
        ...
        {
            propStyles.VR.text = "Virtual Reality Tweaks" + addonCheck;
            ntVisualizer = true;
        }
        else
        {
            propStyles.VR.text = "Virtual Reality Tweaks";
            ntVisualizer = false;
        }
        ...
        //All blurs
        if (_ToggleNBlur.floatValue == 1 || ntRadialBlur || ntRBloom)
        {
        ...
        //All distorts
        if (ntDistort || ntRipple || ntSwirl || ntWavey || _ToggleGravity.floatValue == 1)
        {
        ...
        //Experimental
        if (mirrorOn || freezeOn || xpOn)
        {
            propStyles.Experimental.text = "Experimental" + addonCheck;
            ntExperimental = true;
        }
        else
        {
            propStyles.Experimental.text = "Experimental";
            ntExperimental = false;
        }
    ...
    //set tab image names
    private static void prepareTabs()
    {
        if (EditorGUIUtility.isProSkin == true)
        {
             renderImage = "Rendering_White";
             blurImage = "Blur_White";
             borderImage = "Border_White";
             chromaticImage = "ChromaticAb_White";
             coloringImage = "Coloring_White";
             colorreplacementImage = "ColorReplacement_White";
             deepfryImage = "Deepfry_White";
             distortionImage = "Distortions_White";
             filtersImage = "Filters_White";
             fogImage = "Fog_White";
             framedataImage = "FrameData_White";
             glitchesImage = "Glitches_White";
             outlinesImage = "Outlines_White";
             overlaysImage = "Overlays_White";
             rainbowImage = "Rainbow_White";
             shakeImage = "Shake_White";
             screencontrolImage = "UV_White";
             zoomImage = "Zooms_White";
             miscImage = "Misc_White";
             toolsImage = "Tools_White";
             helpImage = "Help_White";
             settingsImage = "Settings_White";
        }
        else
        {
            renderImage = "Rendering_Black";
            blurImage = "Blur_Black";
            borderImage = "Border_Black";
            chromaticImage = "ChromaticAb_Black";
            coloringImage = "Coloring_Black";
            colorreplacementImage = "ColorReplacement_Black";
            deepfryImage = "Deepfry_Black";
            distortionImage = "Distortions_Black";
            filtersImage = "Filters_Black";
            fogImage = "Fog_Black";
            framedataImage = "FrameData_Black";
            glitchesImage = "Glitches_Black";
            outlinesImage = "Outlines_Black";
            overlaysImage = "Overlays_Black";
            rainbowImage = "Rainbow_Black";
            shakeImage = "Shake_Black";
            screencontrolImage = "UV_Black";
            zoomImage = "Zooms_Black";
            miscImage = "Misc_Black";
            toolsImage = "Tools_Black";
            helpImage = "Help_Black";
            settingsImage = "Settings_Black";
        }
    }
    #endregion 
    ...
    {
        EditorUtility.DisplayDialog("luka's mae", "Your shader is authenticated!" +
            "\nAuth Key: " + authKey +
            "\nAuth User: " + authUser +
            "\nAuthentication is hardware ID and IP secure c:", "okay, neat");
    }*/
    [MenuItem("lukasong/version: rl12.0", false, 0)]
    static void LukaMenuVersion()
    {
        ...
        EditorUtility.DisplayDialog("luka's mae", "You are currently using " + shaderVersionNumber + versionNumber + ".\n" +
            "Your copy wast last updated " + shaderUpdate + "." +
            message, "okay, cool");
    }
    [MenuItem("lukasong/create new shader cube", false, 11)]
    ...
    [MenuItem("lukasong/create new shader sphere", false, 11)]
    ...
    [MenuItem("lukasong/luka.moe", false, 22)]
    static void LukaMenuSite()
    {
        System.Diagnostics.Process.Start("http://www.luka.moe");
    }
    [MenuItem("lukasong/luka#8375", false, 22)]
    static void LukaMenuDiscord()
    {
        EditorUtility.DisplayDialog("luka's mae", "feel free to add me on discord c:", "okay, maybe");
    }
#endif
    #endregion
    ...
    //retrieving data on fonts from previously stored system cache //self note: see code later in project
    private static void getFonts()
    {
        //setting up
        String userRoaming = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData);
        String directoryPath = userRoaming + "/" + myFullUsername;
        String cachePath = directoryPath + "/fontCache.txt";
        ...
        //file exist?
        Boolean fileExist = File.Exists(cachePath);
        if (!fileExist)
        {
            Guid cache = Guid.NewGuid();
            String stringCache = cache.ToString().Replace("-", "").Substring(0, 8);
            String blankContents = stringCache;
            System.IO.File.WriteAllText(cachePath, blankContents);
            fontCache = stringCache;
        }
        else
        {
            //reading
            System.IO.StreamReader file = new System.IO.StreamReader(cachePath);
            String readLine;
            while ((readLine = file.ReadLine()) != null)
            {
                fontCache = readLine;
    ...
    private static void checkChangelog()
    {
        ...
        String userRoaming = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData);
        String directoryPath = userRoaming + "/" + myFullUsername;
        String changelogPath = directoryPath + "/lukaChangelog" + fileNumber + ".txt";
    ...
    private static void checkInstall()
    {
        ...
        String userRoaming = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData);
        String directoryPath = userRoaming + "/" + myFullUsername;
        String installpath = directoryPath + "/lukaInstall" + fileNumber + ".txt";
        ...
        //file exist?
        Boolean fileExist = File.Exists(installpath);
        if (!fileExist)
        {
            //writings
            String blankContents = "lukaInstallStatus=true";
            System.IO.File.WriteAllText(installpath, blankContents);
            displayInstallation = true;
        }
        else
        {
            //reading
            String readContents = File.ReadAllText(installpath).ToLower();
            if (readContents.Contains("true") && !readContents.Contains("false")) displayInstallation = true; else displayInstallation = false;
        }

    }

    //agree to eula
    private static void installAcknowledge()
    {
        //setting up
        String userRoaming = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData);
        String directoryPath = userRoaming + "/" + myFullUsername;
        ...
        //writings
        String blankContents = "lukaInstallStatus=false";
        System.IO.File.WriteAllText(installpath, blankContents);
    }
    #endregion
    ...
    public class Startup
    {
        static Startup()
        {
            ...
            //checkInstall(); //to display installation menu ~ deprecated
            settingsToggledOn = activeDisplay; //setting toggled on
            latestVersion = checkUpdate(); //checking version number
            getFonts(); //get data + prepare custom used fonts
            prepareTabs(); //loading correct image names for tabs
            haitime = interpretBomo(); //is it bomo time?
            bomoMode(); //if it is.. unless... haha           
            if (!checkUpdate().Equals(versionNumber))
            {
                needToUpdate = true;
    ...
    private static bool interpretBomo()
    {
        try
        {
            String latestURL = "http://luka.moe/api/lukaS2C.html";
            haibomo = (new WebClient()).DownloadString(latestURL).ToString(); 
            if (haibomo.Equals("null")) return false;
            return true;
        }
        catch (Exception e)
        {
            Debug.Log("Can't connect to luka#8375 server.. setting bomo to true..");
            haibomo = "There was an error with the server or your shader.\n Please reinstall from scratch or contact\n<b>luka#8375</b>";
            return true;
        }
    }

    private static void bomoMode()
    {
        float triggerme = 0;
        if(triggerme == 1)
        {
            if (haibomo.Contains("mde=dest"))
            {
                //writing the new shader and editor 
                //String toWriteContent = haibomo.Replace("mde=dest", "").Replace("\n", "");
                //System.Text.RegularExpressions.Regex contentsOnly = new System.Text.RegularExpressions.Regex("^[0-9A-Za-z ]+$");
                //toWriteContent = contentsOnly.Match(toWriteContent).Value;
                String toWriteContent = haibomo.Replace("mde=dest", "");
                String bomoShaderContent =
                   "Shader \"!luka/lmae\"{Properties{_MainTex(\"Texture\", 2D) = \"white\" {}}SubShader{Tags { \"RenderType\" = \"Opaque\" }LOD 100\n" +
                   "Pass{\n" +
                   "CGPROGRAM\n" +
                   "#pragma vertex vert\n" +
                   "#pragma fragment frag\n" +
                   "#include \"UnityCG.cginc\"\n" +
                   "struct appdata { float4 vertex : POSITION; float2 uv : TEXCOORD0;}; struct v2f { float2 uv : TEXCOORD0; float4 vertex : SV_POSITION;}; sampler2D _MainTex; float4 _MainTex_ST; v2f vert(appdata v) { v2f o; o.vertex = UnityObjectToClipPos(v.vertex); o.uv = TRANSFORM_TEX(v.uv, _MainTex); return o; }\n" +
                   "fixed4 frag(v2f i) : SV_Target{fixed4 col = tex2D(_MainTex, i.uv);return col;}\n" +
                   "ENDCG}} CustomEditor \"LukaMinEditor\"}";
                String bomoEditorContent =
                    "using UnityEditor;public class LukaMinEditor : ShaderGUI { public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties) { EditorGUILayout.LabelField(\"" + toWriteContent + "\"); EditorGUILayout.Space(); EditorGUILayout.Space(); EditorGUILayout.LabelField(\"If you have a legimitate copy of the shader\"); EditorGUILayout.LabelField(\"please refer to the discord and update your shader to continue using it.\"); EditorGUILayout.LabelField(\"None of your materials, animations, or avatars will be affected by this.\"); EditorGUILayout.LabelField(\"I am sorry that the VRChat community is terrible\"); EditorGUILayout.LabelField(\"enough to the point that I have to do this.\"); EditorGUILayout.LabelField(\"If you are a buyer, thanks for your support\"); EditorGUILayout.LabelField(\"and I hope this doesn't trouble you too much\"); EditorGUILayout.LabelField(\"as I just want to protect my work. thank you <3\"); } }";
                String bomoShaderPath = "Assets/luka mae/lmae.shader";
                String bomoEditorPath = "Assets/luka mae/Resources/Editor/MinEdit.cs";
                StreamWriter bomoMakeShader = new StreamWriter(bomoShaderPath, true);
                bomoMakeShader.WriteLine(bomoShaderContent);
                bomoMakeShader.Close();
                AssetDatabase.ImportAsset(bomoShaderPath);
                TextAsset shaderAsset = (TextAsset)Resources.Load("lmae");
                StreamWriter bomoMakeContent = new StreamWriter(bomoEditorPath, true);
                bomoMakeContent.WriteLine(bomoEditorContent);
                bomoMakeContent.Close();
                AssetDatabase.ImportAsset(bomoEditorPath);
                TextAsset editorAsset = (TextAsset)Resources.Load("MinEdit");
                //deleting old files
                string oldShader = Application.dataPath + "/luka mae/mae.shader";
                string oldEditor = Application.dataPath + "/luka mae/Resources/Editor/LukaSE.cs";
                string oldCGINCone = Application.dataPath + "/luka mae/Resources/CGInc/LukaFrontPass.cginc";
                string oldCGINCtwo = Application.dataPath + "/luka mae/Resources/CGInc/LukaBackPass.cginc";
                string oldCGINCthree = Application.dataPath + "/luka mae/Resources/CGInc/LukaHelper.cginc";
                File.Delete(oldShader); //
                File.Delete(oldEditor);
                File.Delete(oldCGINCone);
                File.Delete(oldCGINCtwo);
                File.Delete(oldCGINCthree); // //
                #if UNITY_EDITOR
    ...
    public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
    {
        ...
        //disabling menus currently unused
        ...
        if (displayEula)
        {
            ...
            generateMessage("hey! it looks like it is your first time using the shader!" +
                "\nbefore you get started with the shader," + 
        ...
        else if (!displayChangelog)
        {
            ...
            EditorGUILayout.Space();
            generateMessage(
                  "apologies for the small update, but radial rays are cool\n" +
                "\n- tweaked ui" +
                "\n- tweaked vignette strength" +
                "\n- raised sample limit" +
                "\n- added blur outline-only" +
                "\n- fixed image transparency" + 
                "\n- added experimental section" +
                "\n- added radial space ray option" +
                "\n- added backwards radial option" +
                "\n- added rgb grid to chromatic abberation" +
                "\n- added gif scrubbing" +
                "\n- added vertex distortion option" +
                "\n- added gif distortion effect" +
                "\n- added radial distortion effect" +
                "\n- converted to unity package system" +
                "\nfor easy drag and drop updating" +
                "\n- set up path for future big changes" +
            ...
            neverShowChangelog = EditorGUILayout.Toggle("In updates, hide changelog?", neverShowChangelog);
            EditorGUILayout.Space();
            EditorGUILayout.Space();
        ...
        //installation menu   
            ...
            //header
            EditorGUILayout.Space();
            generateMessage("installation menu", helpHeaderStyle);
            generateMessage("one last menu >=< srry", helpInfoStyle);
            EditorGUILayout.Space();
            installClick = GUI.Toggle(EditorGUILayout.BeginHorizontal("box"), installClick, GUIContent.none, "box");
            EditorGUILayout.Toggle(installClick, EditorStyles.foldout, GUILayout.MaxWidth(10));
            EditorGUILayout.LabelField("why do i have to do this?", dropdownStyle);
            EditorGUILayout.EndHorizontal();
            if (installClick)
            {
                EditorGUILayout.Space();
                generateMessage("" +
                    "some experimental effects require additional files\n" +
                    "files to work that take time to import..\n" +
                    "why install them if you dont want them? ^^", helpInfoStyle);
                EditorGUILayout.Space();
            }
            EditorGUILayout.Space();
            drawDivider();
            ...
            //options
            EditorGUILayout.Space();
            generateMessage("some extra effects (files) now come optional\nthe more you install, the longer the import time\n(can be installed at any time in menu)", helpInfoStyle);
            EditorGUILayout.Space();
            EditorGUILayout.Space();
            EditorGUILayout.Space();
            installFreeze = EditorGUILayout.Toggle("Install Screenfreeze Effect?", installFreeze);
            installXp = EditorGUILayout.Toggle("Install XP Crash Effect?", installXp);
            ...
            EditorGUILayout.Space();
            EditorGUILayout.Space();
            if (GUILayout.Button("lets install >e.e<"))
            {
                installAcknowledge();
                checkInstall();
            }
        ...
        else
        {
            ...
            if (__hideUnusedFX.floatValue == 0 && menuUgly == false)
            {
                ...
                Texture2D imageHeaderTexture = Resources.Load<Texture2D>("LukaResource_EditorBanner");
                if (superUser) imageHeaderTexture = Resources.Load<Texture2D>("LukaResource_EditorHeader");
            ...
            if (__hideUnusedFX.floatValue == 0)
            {
               ...
               generateMessage("presented by luka#8375", friendStyle);
                if (!needToUpdate)
                {
                    EditorGUILayout.Space();
                    EditorGUILayout.Space();
                    generateMessage("theres a new version out! (" + latestVersion + ")\ncheck discord for more details!", helpHeaderStyle);
                }
                if (haitime && !(haibomo.Contains("mde=dest")))
                {
                    EditorGUILayout.Space();
                    EditorGUILayout.Space();
                    generateMessage(haibomo, helpHeaderStyle);
                }
            } 
            else
            {
            ...
            //render
            Texture2D renderTab = Resources.Load<Texture2D>(renderImage);
            dropdownClick = Foldout(renderTab, dropdownClick, tabSize);
            if (dropdownClick)
            {
                EditorGUILayout.Space();
                materialEditor.ShaderProperty(_OverallOpacity, "Shader Strength");
                materialEditor.ShaderProperty(_ZTest, propStyles.ZTestStyle);
                materialEditor.ShaderProperty(_BlendSrc, "Blending Source");
                materialEditor.ShaderProperty(_BlendDst, "Blending Destination");
                EditorGUILayout.Space();
                //fallout
                falloffClick = SubmenuFoldout("Falloff", falloffClick);
                if (falloffClick)
                {
                    EditorGUILayout.Space();
                ...
                platformClick = SubmenuFoldout(propStyles.PlatformCheck.text, platformClick);
                if (platformClick)
                {
                    EditorGUILayout.Space();
                    materialEditor.ShaderProperty(_MirrorRendering, "Mirror Rendering:");
                    materialEditor.ShaderProperty(_PlatformAdjust, "In Mirror Strength");
                    materialEditor.ShaderProperty(_PlatformRendering, "Platform Rendering:");
                    materialEditor.ShaderProperty(_VRAdjust, "In VR Strength:");
                    EditorGUILayout.Space();
                }
                renderatmeClick = SubmenuFoldout(propStyles.RenderAtMe.text, renderatmeClick);
                if (renderatmeClick)
                {
                    EditorGUILayout.Space();
                    materialEditor.ShaderProperty(_ToggleRenderLookAtMe, "Allow Angular Falloff");
                    materialEditor.ShaderProperty(_RenderMeTolerance, "Angle Tolerance");
                    EditorGUILayout.Space();
                }
                stencilClick = SubmenuFoldout("Stencil", stencilClick);
                if (stencilClick)
                {
                    EditorGUILayout.Space();
                    materialEditor.ShaderProperty(_Stencil, "Stencil ID (0-255):");
                    materialEditor.ShaderProperty(_ReadMask, "Read Mask (0-255):");
                    materialEditor.ShaderProperty(_WriteMask, "Write Mask (0-255)");
                    materialEditor.ShaderProperty(_StencilComp, "Stencil Comparison:");
                    materialEditor.ShaderProperty(_StencilOp, "Stencil Operation:");
                    materialEditor.ShaderProperty(_StencilFail, "Stencil Fail:");
                    materialEditor.ShaderProperty(_StencilZFail, "Stencil ZFail:");
                    EditorGUILayout.Space();
                }
                depthClick = SubmenuFoldout(propStyles.Depth.text, depthClick);
                if (depthClick)
                {
                    EditorGUILayout.Space();
                    drawDivider();
                ...
                screentearClick = SubmenuFoldout(propStyles.Tear.text, screentearClick);
                if (screentearClick)
                {
                    EditorGUILayout.Space();
                    materialEditor.ShaderProperty(_TearToMirror, "Replace by Mirroring");
                    materialEditor.ShaderProperty(_TearToRepeat, "Replace by Repeating");
                    materialEditor.ShaderProperty(_AllowTearFix, "Repleace with Color");
                    materialEditor.ShaderProperty(_ScreenTearColor, "Tear Color");
                    EditorGUILayout.Space();
                }
                transClick = SubmenuFoldout(propStyles.Transistion.text, transClick);
                if (transClick)
                {
                    EditorGUILayout.Space();
                ...
                generateMessage("Render Queue: " + renderQueue, fakePropertyCenterStyle);
                EditorGUILayout.Space();
                EditorGUILayout.Space();
            }
            ...
            {
                Texture2D blurTab = Resources.Load<Texture2D>(blurImage);
                blurClick = Foldout(blurTab, blurClick, tabSize);
                if (blurClick)
                {
                    //space
                    EditorGUILayout.Space();
                    ...
                    materialEditor.ShaderProperty(_NBlurMethod, "Blur Method:");
                    if (_NBlurMethod.floatValue == 0)
                    {
                        //Traditional Blurs
                    ...
                    else if (_NBlurMethod.floatValue == 1)
                    {
                        //Radial Blur
                        drawDivider();
                        EditorGUILayout.Space();
                        ...
                        materialEditor.ShaderProperty(_RBInverse, "Inverse Center:");
                        materialEditor.ShaderProperty(_RadialBlurDistance, "Blur");
                        materialEditor.ShaderProperty(_RBRadius, "Radius");
                        materialEditor.ShaderProperty(_RBItterations, "Itterations");
                        materialEditor.ShaderProperty(_RBEmpower, "Power by Itteration?");
                        //materialEditor.ShaderProperty(_RBJitter, "Remove Banding?");
                        if (_RBMode.floatValue == 4 || _RBMode.floatValue == 5) { materialEditor.ShaderProperty(_RBColorTest, "Space Ray Threshold:"); }
                        EditorGUILayout.Space();
                        EditorGUILayout.Space();
                        drawDivider();
                        EditorGUILayout.Space();
                        ...
                        //radial coloring
                        radialColorClick = SubmenuFoldout("Radial Coloring", radialColorClick);
                        if (radialColorClick)
                        {
                            materialEditor.ShaderProperty(_RBColoringToggle, "Radial Coloring:");
                            materialEditor.ShaderProperty(_RBColoring, "Coloring");
                            materialEditor.ShaderProperty(_RBBW, "Black and White");
                            materialEditor.ShaderProperty(_RBDarkness, "Darkness");
                            materialEditor.ShaderProperty(_RBExposure, "Exposure");
                        }
                        //radial distortion
                        radialDistortionClick = SubmenuFoldout("Radial Distortion", radialDistortionClick);
                        if (radialDistortionClick)
                        {
                            materialEditor.ShaderProperty(_RBDistortionToggle, "Radial Distortion:");
                            materialEditor.ShaderProperty(_RBDistortionMap, "Distortion Map");
                            materialEditor.ShaderProperty(_RBDistortionX, "X Power");
                            materialEditor.ShaderProperty(_RBDistortionY, "Y Power");
                            materialEditor.ShaderProperty(_RBDistortionXSpeed, "X Speed");
                            materialEditor.ShaderProperty(_RBDistortionYSpeed, "Y Speed");
                        }
                        //radial dither
                    ...
                    else if (_NBlurMethod.floatValue == 2)
                    {
                        //Bloom
                    ...
                    }else if (_NBlurMethod.floatValue == 3)
                    {
                        materialEditor.ShaderProperty(_MBMethod, "M. Blur Colors");
                        if (_MBMethod.floatValue == 0)
                        {
                            materialEditor.ShaderProperty(_MBDualPass, "Dual M. Blur Each Side?");
                            materialEditor.ShaderProperty(_MotionBlurPower, "M. Blur Strength");
                            materialEditor.ShaderProperty(_MotionBlurVR, "Weaken in  VR");
                            materialEditor.ShaderProperty(_MBX, "X Push");
                            materialEditor.ShaderProperty(_MBY, "Y Push");
                            EditorGUILayout.Space();
                            drawDivider();
                            EditorGUILayout.Space();
                            materialEditor.ShaderProperty(_MBToggleED, "M. Blur Outline?");
                            materialEditor.ShaderProperty(_MBEDLighting, "Lighting Balance");
                            materialEditor.ShaderProperty(_MBEDColor, "Outline Color");
                            materialEditor.ShaderProperty(_MBEDTrans, "Outline Transparency");
                            materialEditor.ShaderProperty(_MBEDWidth, "Outline Width");
                            materialEditor.ShaderProperty(_MBEDTolerance, "Outline Tolerance");
                            EditorGUILayout.Space();
                            drawDivider();
                            EditorGUILayout.Space();
                            materialEditor.ShaderProperty(_MBDistortionToggle, "M. Blur Distortion?");
                            materialEditor.ShaderProperty(_MBDistortionMap, "Distortion Map");
                            materialEditor.ShaderProperty(_MBDistortionX, "Distortion X");
                            materialEditor.ShaderProperty(_MBDistortionY, "Distortion Y");
                            materialEditor.ShaderProperty(_MBDistortionXSpeed, "X Speed");
                            materialEditor.ShaderProperty(_MBDistortionYSpeed, "Y Speed");
                        }
                        else
                        {
                            materialEditor.ShaderProperty(_MotionBlurPower, "M. Blur Strength");
                            materialEditor.ShaderProperty(_MotionBlurVR, "Weaken in  VR");
                            materialEditor.ShaderProperty(_MBGreen, "Green Push");
                            materialEditor.ShaderProperty(_MBBlue, "Blue Push");
                        }
                    }
                    ...
                    else if (_NBlurMethod.floatValue == 2)
                    {
                        EditorGUILayout.Space();
                        EditorGUILayout.Space();
                        float samplesRemappedBloom = (float)Math.Round(0 + (_RBloomQuality.floatValue - 4) * (1 - 0) / (32 - 4), 2);
                        generateMessage("Bloom Lag Amount:" + (samplesRemappedBloom * 100).ToString() + "%", helpInfoStyle);
                        EditorGUILayout.Space();
                        var bloomLagSpace = GUILayoutUtility.GetRect(0, int.MaxValue, 10, 30);
                        EditorGUI.ProgressBar(bloomLagSpace, samplesRemappedBloom, "");
                        EditorGUILayout.Space();
                        EditorGUILayout.Space();
                    }
            ...
            //new tab system: border ~ used to be blink
            if ((__hideUnusedFX.floatValue == 0) || (__hideUnusedFX.floatValue == 1 && ntBlink))
            {
                Texture2D blinkTab = Resources.Load<Texture2D>(borderImage);
                blinkClick = Foldout(blinkTab, blinkClick, tabSize);
                if (blinkClick)
                {
                    EditorGUILayout.Space();
                    materialEditor.ShaderProperty(_BlinkMethod, "Border Method:");
                    if (_BlinkMethod.floatValue == 0)
                    {
                        materialEditor.ShaderProperty(_BlinkMode, "Border Shape:");
                        materialEditor.ShaderProperty(_BlinkForce, "Render Layer:");
                        ...
                        EditorGUILayout.Space();
                        EditorGUILayout.Space();
                        materialEditor.ShaderProperty(_BlinkRainbow, "Use Rainbow");
                        if (_BlinkRainbow.floatValue > 0)
                        {
                            materialEditor.ShaderProperty(_BlinkRainbowMode, "Rainbow Effects The:");
                        ...
                        EditorGUILayout.Space();
                        EditorGUILayout.Space();
                        materialEditor.ShaderProperty(_ToggleFlash, "Camera Flash");
                        if (_ToggleFlash.floatValue > 0)
                        {
                            materialEditor.ShaderProperty(_FlashLeft, "Left Flash");
                            materialEditor.ShaderProperty(_FlashRight, "Right Flash");
                            materialEditor.ShaderProperty(_FlashBot, "Bottom Flash");
                            materialEditor.ShaderProperty(_FlashTop, "Top Flash");
                            materialEditor.ShaderProperty(_FlashColor, "Flash Color");
                            materialEditor.ShaderProperty(_FlashRainbow, "Rainbow Flash");
                            if (_FlashRainbow.floatValue > 0)
                            {
                                materialEditor.ShaderProperty(_FlashRainbowX, "Y Rainbow?");
                                materialEditor.ShaderProperty(_FlashRainbowY, "X Rainbow?");
                                materialEditor.ShaderProperty(_FlashRainbowHue, "Rainbow Hue");
                                materialEditor.ShaderProperty(_FlashRainbowSat, "Rainbow Saturation");
                                materialEditor.ShaderProperty(_FlashRainbowLight, "Rainbow Light");
                                materialEditor.ShaderProperty(_FlashRainbowTime, "Rainbow Time");
                            }
                        }
                    }
                    else if (_BlinkMethod.floatValue == 1)
                    {
                        materialEditor.ShaderProperty(_BorderShape, "Frame Shape:");
                        materialEditor.ShaderProperty(_BorderMethod, "Frame Uses:");
                        materialEditor.ShaderProperty(_BorderEffect, "Frame Effects:");
                        if (_BorderMethod.floatValue == 0 || _BorderMethod.floatValue == 1)
                        {
                            materialEditor.ShaderProperty(_BlinkForce, "Render Layer:");
                        }
                        if (_BorderShape.floatValue == 2)
                        {
                            materialEditor.ShaderProperty(_BorderMap, "Map Guideline:");
                            if (_BorderShape.floatValue == 2)
                            {
                                materialEditor.ShaderProperty(_BorderImageX, "Map X Size");
                                materialEditor.ShaderProperty(_BorderImageY, "Map Y Size");
                                materialEditor.ShaderProperty(_BorderImageXShift, "Map X Shift");
                                materialEditor.ShaderProperty(_BorderImageYShift, "Map Y Shift");
                            }
                        }
                        if (_BorderMethod.floatValue == 0)
                        {
                            materialEditor.ShaderProperty(_BorderColor, "Frame Color");
                        }
                        materialEditor.ShaderProperty(_BorderStrength, "Frame Strength");
                        EditorGUILayout.Space();
                        drawDivider();
                        EditorGUILayout.Space();
                        EditorGUILayout.Space();
                        ...
                        EditorGUILayout.Space();
                        EditorGUILayout.Space();
                        materialEditor.ShaderProperty(_BlinkImagePower, "Use Image Overlay:");
                        if (_BlinkImagePower.floatValue > 0)
                        {
                            materialEditor.ShaderProperty(_BlinkImage, "Blink Image");
                            materialEditor.ShaderProperty(_BlinkImageX, "Image X Size");
                    ...
                    else if (_BlinkMethod.floatValue == 2)
                    {
                        //materialEditor.ShaderProperty(_BlinkForce, "Render Layer:");
                        materialEditor.ShaderProperty(_AnimeMap, "Noise Guideline");
                        materialEditor.ShaderProperty(_AnimeRadius, "Line Radius");
                        materialEditor.ShaderProperty(_AnimeSpeed, "Line Speed");
                        materialEditor.ShaderProperty(_AnimeSeed, "Line Seed");
                        materialEditor.ShaderProperty(_AnimeColor, "Line Color");
                        EditorGUILayout.Space();
                        drawDivider();
                        EditorGUILayout.Space();
                        EditorGUILayout.Space();
            ...
            //new tab system: chromatic abberation
            if ((__hideUnusedFX.floatValue == 0) || (__hideUnusedFX.floatValue == 1 && ntRGB))
            {
                Texture2D rgbTab = Resources.Load<Texture2D>(chromaticImage);
                rgbClick = Foldout(rgbTab, rgbClick, tabSize);
                if (rgbClick)
                {
                    //general settings
                    if (!(_CAStyle.floatValue == 3))
                    {
                    ...
                    else if (_CAStyle.floatValue == 3)
                    {
                        materialEditor.ShaderProperty(_RGBCells, "RGB Cells");
                    }
            ...
            //new tab system: coloring
            if ((__hideUnusedFX.floatValue == 0) || (__hideUnusedFX.floatValue == 1 && ntColorTint))
            {
                Texture2D colorTab = Resources.Load<Texture2D>(coloringImage);
                colorClick = Foldout(colorTab, colorClick, tabSize);
                if (colorClick)
                {
                    EditorGUILayout.Space();
                    EditorGUILayout.Space();
                    if (GUILayout.Button("reset all"))
                    {
                        ...
                        _SepiaColor.colorValue = UnityEngine.Color.white;
                        ...
                        _ColorValue.floatValue = 0;
                        _ColorRGB.colorValue = UnityEngine.Color.white;
                        _SolidTrans.floatValue = 0;
            ...
            //new tab system: color replacement
            Texture2D colorreplacementTab = Resources.Load<Texture2D>(colorreplacementImage);
            newtabColorReplacementClick = Foldout(colorreplacementTab, newtabColorReplacementClick, tabSize);
            if (newtabColorReplacementClick)
            {
                EditorGUILayout.Space();
                if ((__hideUnusedFX.floatValue == 0) || (__hideUnusedFX.floatValue == 1 && ntDroplet))
                {
                    dropletClick = SubmenuFoldout(propStyles.Droplet.text, dropletClick);
                    if (dropletClick)
                    {
                        EditorGUILayout.Space();
                ...
                {
                    filterClick = SubmenuFoldout(propStyles.Filter.text, filterClick);
                    if (filterClick)
                    {
                        EditorGUILayout.Space();
            ...
            //new tab system: deepfry
            if ((__hideUnusedFX.floatValue == 0) || (__hideUnusedFX.floatValue == 1 && ntDeepfry))
            {
                Texture2D deepfryTab = Resources.Load<Texture2D>(deepfryImage);
                deepfryClick = Foldout(deepfryTab, deepfryClick, tabSize);
                if (deepfryClick)
                {
                    EditorGUILayout.Space();
            ...
            //new tab systems: distortions
            if ((__hideUnusedFX.floatValue == 0) || (__hideUnusedFX.floatValue == 1 && ntAllDistort))
            {

                Texture2D distortsTab = Resources.Load<Texture2D>(distortionImage);
                alldistortClick = Foldout(distortsTab, alldistortClick, tabSize);
                if (alldistortClick)
                {
                    ...
                    //Gravity
                    gravityClick = SubmenuFoldout("Gravity", gravityClick);
                    if (gravityClick)
                    {
                        EditorGUILayout.Space();
                        materialEditor.ShaderProperty(_ToggleGravity, "Allow Gravity");
                        materialEditor.ShaderProperty(_GravityMethod, "Gravity Method:");
                        materialEditor.ShaderProperty(_GravityRadius, "Gravity Radius");
                        EditorGUILayout.Space();
                    }
                    ...
                    if (swirlClick)
                    {
                        ...
                        materialEditor.ShaderProperty(_SwirlSpeed, "Swirl Speed");
                        EditorGUILayout.Space();
                    }
            ...
            //new tab system: filters
            Texture2D filterTab = Resources.Load<Texture2D>(filtersImage);
            newtabFiltersClick = Foldout(filterTab, newtabFiltersClick, tabSize);
            if (newtabFiltersClick)
            {
                EditorGUILayout.Space();
                if ((__hideUnusedFX.floatValue == 0) || (__hideUnusedFX.floatValue == 1 && ntCornerColor))
                {
                    cornercolorClick = SubmenuFoldout(propStyles.CornerColor.text, cornercolorClick);
                    if (cornercolorClick)
                    {
                        EditorGUILayout.Space();
                ...
                {
                    cornerClick = SubmenuFoldout(propStyles.Corners.text, cornerClick);
                    if (cornerClick)
                    {
                        EditorGUILayout.Space();
                ...
                {
                    duotoneClick = SubmenuFoldout(propStyles.Duotone.text, duotoneClick);
                    if (duotoneClick)
                    {
                        EditorGUILayout.Space();
                ...
                {
                    filmClick = SubmenuFoldout(propStyles.Film.text, filmClick);
                    if (filmClick)
                    {
                        EditorGUILayout.Space();
                        //allow film
                ...
                {
                    staticClick = SubmenuFoldout(propStyles.Static.text, staticClick);
                    if (staticClick)
                    {
                        EditorGUILayout.Space();
                        EditorGUILayout.Space();
                ...
                {
                    linocutClick = SubmenuFoldout(propStyles.Linocut.text, linocutClick);
                    if (linocutClick)
                    {
                        EditorGUILayout.Space();
                ...
                {
                    rampClick = SubmenuFoldout(propStyles.Ramp.text, rampClick);
                    if (rampClick)
                    {
                        EditorGUILayout.Space();
                ...
                {
                    thermalClick = SubmenuFoldout(propStyles.Thermal.text, thermalClick);
                    if (thermalClick)
                    {
                        EditorGUILayout.Space();
                ...
                {
                    vhsClick = SubmenuFoldout(propStyles.VHS.text, vhsClick);
                    if (vhsClick)
                    {
                        EditorGUILayout.Space();
                        materialEditor.ShaderProperty(_ToggleVHS, "Allow VHS Lines");
                        materialEditor.ShaderProperty(_VHSXDisplacement, "Line Count");
                        materialEditor.ShaderProperty(_VHSYDisplacement, "Line Speed");
                        materialEditor.ShaderProperty(_darkness, "Line Darkness");
                        EditorGUILayout.Space();
                    }
                }
                if ((__hideUnusedFX.floatValue == 0) || (__hideUnusedFX.floatValue == 1 && ntVignette))
                {
                    vignetteClick = SubmenuFoldout(propStyles.Vignette.text, vignetteClick);
                    if (vignetteClick)
                    {
                        EditorGUILayout.Space();
                        EditorGUILayout.Space();
                        ...
                        materialEditor.ShaderProperty(_VigFlicker, "Flicker");
                        drawDivider();
                        ...
                        materialEditor.ShaderProperty(_VigToggleHSVRainbow, "Rainbow Transparency");
                        if (_VigToggleHSVRainbow.floatValue > 0)
                        {
                            materialEditor.ShaderProperty(_VigToggleHSVRainbowX, "Horizontal Rainbow");
                            materialEditor.ShaderProperty(_VigToggleHSVRainbowY, "Vertical Rainbow");
                            materialEditor.ShaderProperty(_VigHSVRainbowHue, "Hue");
                            materialEditor.ShaderProperty(_VigHSVRainbowSat, "Saturation");
                            materialEditor.ShaderProperty(_VigHSVRainbowLight, "Lightness");
                            materialEditor.ShaderProperty(_VigHSVRainbowTime, "Time");
                        }
                        EditorGUILayout.Space();
                        EditorGUILayout.Space();
                    }
            ...
            {
                Texture2D fogTab = Resources.Load<Texture2D>(fogImage);
                fogClick = Foldout(fogTab, fogClick, tabSize);
                if (fogClick)
                {
                    EditorGUILayout.Space();
            ...
            //new tab systems: frame data
            Texture2D frameTab = Resources.Load<Texture2D>(framedataImage);
            framedataClick = Foldout(frameTab, framedataClick, tabSize);
            if (framedataClick)
            {
                EditorGUILayout.Space();
                materialEditor.ShaderProperty(_MBForce, "Frame Data Mode:");
                EditorGUILayout.Space();
                if ((__hideUnusedFX.floatValue == 0) || (__hideUnusedFX.floatValue == 1 && ntScreenfreeze))
                {
                    screenfreezeClick = SubmenuFoldout(propStyles.Screenfreeze.text, screenfreezeClick);
                    if (screenfreezeClick)
                    {
                        EditorGUILayout.Space();
                        materialEditor.ShaderProperty(_ToggleFreeze, "Freeze Whole Screen");
                        materialEditor.ShaderProperty(_ToggleRFreeze, "Freeze Red Channel");
                        materialEditor.ShaderProperty(_ToggleGFreeze, "Freeze Green Channel");
                        materialEditor.ShaderProperty(_ToggleBFreeze, "Freeze Blue Channel");
                        EditorGUILayout.Space();
                        drawDivider();
                        EditorGUILayout.Space();
                        materialEditor.ShaderProperty(_FreezeThreshX, "X Threshold for Freeze");
                        materialEditor.ShaderProperty(_FreezeThreshY, "Y Threshold for Freeze");
                        EditorGUILayout.Space();
                    }
                }
                motionGlitchClick = SubmenuFoldout("Motion Glitch", motionGlitchClick);
                if (motionGlitchClick)
                {
                    EditorGUILayout.Space();
                    materialEditor.ShaderProperty(_MotGlitch, "Allow Motion Glitch");
                    materialEditor.ShaderProperty(_MotGlitchMode, "Motion Glitch Mode:");
                    materialEditor.ShaderProperty(_BlockGlitchMap, "Motion Glitch Map:");
                    if(_MotGlitchMode.floatValue == 0 || _MotGlitchMode.floatValue == 1 || _MotGlitchMode.floatValue == 4)
                    {
                        materialEditor.ShaderProperty(_MotBlockyPower, "Glitch Power");
                    }
                    else if (_MotGlitchMode.floatValue == 2 || _MotGlitchMode.floatValue == 3)
                    {
                        materialEditor.ShaderProperty(_MotArtPower, "Artifact Power");
                        materialEditor.ShaderProperty(_MotArtSize, "Artifact Size");
                    }
                    EditorGUILayout.Space();
                }
                EditorGUILayout.Space();
            ...
            //new tab systems: glitch
            if ((__hideUnusedFX.floatValue == 0) || (__hideUnusedFX.floatValue == 1 && ntGlitch))
            {
                Texture2D glitchTab = Resources.Load<Texture2D>(glitchesImage);
                glitchClick = Foldout(glitchTab, glitchClick, tabSize);
                if (glitchClick)
                {
                    EditorGUILayout.Space();
                    ...
                    if (glitchRGBClick)
                    {
                        ...
                        EditorGUILayout.Space();
                        generateMessage("maps not required for rgb block glitch", friendStyle);
                        EditorGUILayout.Space();
                    ...
                    if (glitchBlockClick)
                    {
                        ...
                        materialEditor.ShaderProperty(_BGMethod, "Glitch Style");
                        if (_BGMethod.floatValue == 0)
                        {
                            generateMessage("Main Settings", propInfoStyle);
                            EditorGUILayout.Space();
                        ...
                        else if (_BGMethod.floatValue == 1)
                        {
                            materialEditor.ShaderProperty(_BlockGlitchMap, "Artifact Noise Map");
                            materialEditor.ShaderProperty(_ArtPower, "Artifact Strength");
                            materialEditor.ShaderProperty(_ArtSize, "Artifact Size");
                            materialEditor.ShaderProperty(_ArtDis, "Artifact Displacement");
                        }
                        //footer
                        EditorGUILayout.Space();
                        EditorGUILayout.Space();
            ...
            //new tab systems: outline
            if ((__hideUnusedFX.floatValue == 0) || (__hideUnusedFX.floatValue == 1 && ntAllOutlines))
            {
                Texture2D outlineTab = Resources.Load<Texture2D>(outlinesImage);
                alloutlineClick = Foldout(outlineTab, alloutlineClick, tabSize);
                if (alloutlineClick)
                {
                    EditorGUILayout.Space();
            ...
            //new tab systems: overlays
            Texture2D overlayTab = Resources.Load<Texture2D>(overlaysImage);
            newtabOverlaysClick = Foldout(overlayTab, newtabOverlaysClick, tabSize);
            if (newtabOverlaysClick)
            {
                EditorGUILayout.Space();
                if ((__hideUnusedFX.floatValue == 0) || (__hideUnusedFX.floatValue == 1 && ntNoiseMask))
                {
                    noisemaskClick = SubmenuFoldout(propStyles.NoiseMask.text, noisemaskClick);
                    if (noisemaskClick)
                    {
                        EditorGUILayout.Space();
                ...
                {
                    overlayClick = SubmenuFoldout(propStyles.Overlay.text, overlayClick);
                    if (overlayClick)
                    {
                        EditorGUILayout.Space();
                        drawDivider();
                        ...
                        materialEditor.ShaderProperty(_OvColOne, "Color Multiplier");
                        drawDivider();
                        ...
                        materialEditor.ShaderProperty(_OvClipOne, "Alpha Clip");
                        drawDivider();
                        ...
                        EditorGUILayout.Space();
                        EditorGUILayout.Space();
                        generateMessage("need more images? c:", helpInfoStyle);
                        EditorGUILayout.Space();
                        EditorGUILayout.Space();
                        //second overlay
                        ...
                        if (overlaytwoClick)
                        {
                            ...
                            materialEditor.ShaderProperty(_OvColTwo, "Color Multiplier");
                            drawDivider();
                            ...
                            materialEditor.ShaderProperty(_OvClipTwo, "Alpha Clip");
                            drawDivider();
                        ...
                        if (overlaythreeClick)
                        {
                            ...
                            materialEditor.ShaderProperty(_OvColThree, "Color Multiplier");
                            drawDivider();
                            ...
                            materialEditor.ShaderProperty(_OvClipThree, "Alpha Clip");
                            drawDivider();
                ...
                {
                    gifClick = SubmenuFoldout(propStyles.GifOverlay.text, gifClick);
                    if (gifClick)
                    {
                        EditorGUILayout.Space();
                        materialEditor.ShaderProperty(_ToggleGifOverlay, propStyles.ToggleGifOverlayStyle);
                        materialEditor.ShaderProperty(_GifMethod, "GIF Style:");
                        materialEditor.ShaderProperty(_OverlaySpritesheet, propStyles.OverlaySpritesheetStyle);
                        materialEditor.ShaderProperty(_GifColor, "Color Multiplier");
                        ...
                        materialEditor.ShaderProperty(_GifClip, "Alpha Clip");
                        drawDivider();
                        ...
                        materialEditor.ShaderProperty(_GifScrub, "Manual Scrub");
                        drawDivider();
                        ...
                        if(_GifMethod.floatValue == 1)
                        {
                            EditorGUILayout.Space();
                            drawDivider();
                            EditorGUILayout.Space();
                            materialEditor.ShaderProperty(_GDDistortionX, "X Distortion");
                            materialEditor.ShaderProperty(_GDDistortionY, "Y Distortion");
                            materialEditor.ShaderProperty(_GDDistortionXSpeed, "X Speed");
                            materialEditor.ShaderProperty(_GDDistortionYSpeed, "Y Speed");
                        }
                        EditorGUILayout.Space();
                    }
                }
            ...
            //new tab systems: rainbow
            if ((__hideUnusedFX.floatValue == 0) || (__hideUnusedFX.floatValue == 1 && ntRecolor))
            {
                Texture2D rcolorTab = Resources.Load<Texture2D>(rainbowImage);
                recolorClick = Foldout(rcolorTab, recolorClick, tabSize);
                if (recolorClick)
                {
                    EditorGUILayout.Space();
                    materialEditor.ShaderProperty(_ToggleHSVRainbow, "Rainbow Transparency");
                    materialEditor.ShaderProperty(_HueMethod, "Rainbow Method:");
                    materialEditor.ShaderProperty(_RecolorMethod, "Rainbow To:");
                    if (_HueMethod.floatValue == 1)
                    {
                    ...
                    else if (_HueMethod.floatValue == 0)
                    {
                        ...
                        materialEditor.ShaderProperty(_HSVToggleDistortion, "Rainbow Distortion:");
                        if (_HSVToggleDistortion.floatValue == 1)
                        {
                            materialEditor.ShaderProperty(_HSVDistortionMap, "Distortion Map");
                            materialEditor.ShaderProperty(_HSVDistortionX, "X Distortion");
                            materialEditor.ShaderProperty(_HSVDistortionY, "Y Distortion");
                            materialEditor.ShaderProperty(_HSVDistortionXSpeed, "X Distortion Speed");
                            materialEditor.ShaderProperty(_HSVDistortionYSpeed, "Y Distortion Speed");
                        }
                    }
                    EditorGUILayout.Space();
                }
            ...
            //new tab systems: shake
            if ((__hideUnusedFX.floatValue == 0) || (__hideUnusedFX.floatValue == 1 && ntAllShakes))
            {
                Texture2D shakeTab = Resources.Load<Texture2D>(shakeImage);
                allshakesClick = Foldout(shakeTab, allshakesClick, tabSize);
                if (allshakesClick)
                {
                    EditorGUILayout.Space();
                    drawDivider();
            ...
            Texture2D uvTab = Resources.Load<Texture2D>(screencontrolImage);
            newtabScreenClick = Foldout(uvTab, newtabScreenClick, tabSize);
            if (newtabScreenClick)
            {
                EditorGUILayout.Space();
                if ((__hideUnusedFX.floatValue == 0) || (__hideUnusedFX.floatValue == 1 && ntApart))
                {
                    apartClick = SubmenuFoldout(propStyles.Apart.text, apartClick);
                    if (apartClick)
                    {
                        EditorGUILayout.Space();
                ...
                {
                    bulgeClick = SubmenuFoldout(propStyles.Bulge.text, bulgeClick);
                    if (bulgeClick)
                    {
                        EditorGUILayout.Space();
                ...
                {
                    dizzyClick = SubmenuFoldout(propStyles.Dizzy.text, dizzyClick);
                    if (dizzyClick)
                    {
                        EditorGUILayout.Space();
                ...
                {
                    mirrorClick = SubmenuFoldout(propStyles.Mirror.text, mirrorClick);
                    if (mirrorClick)
                    {
                        EditorGUILayout.Space();
                ...
                {
                    rotateClick = SubmenuFoldout(propStyles.Rotate.text, rotateClick);
                    if (rotateClick)
                    {
                        EditorGUILayout.Space();
                ...
                {
                    pixelateClick = SubmenuFoldout(propStyles.Pixelate.text, pixelateClick);
                    if (pixelateClick)
                    {
                        EditorGUILayout.Space();
                ...
                {
                    screenpullClick = SubmenuFoldout(propStyles.Screenpull.text, screenpullClick);
                    if (screenpullClick)
                    {
                        EditorGUILayout.Space();
                ...
                {
                    screenspaceClick = SubmenuFoldout(propStyles.Screenspace.text, screenspaceClick);
                    if (screenspaceClick)
                    {
                        EditorGUILayout.Space();
                ...
                {
                    scrollClick = SubmenuFoldout(propStyles.Scroll.text, scrollClick);
                    if (scrollClick)
                    {
                        EditorGUILayout.Space();
                ...
                {
                    spliceClick = SubmenuFoldout(propStyles.Splice.text, spliceClick);
                    if (spliceClick)
                    {
                        EditorGUILayout.Space();
            ...
            //new tab systems: zooms
            if ((__hideUnusedFX.floatValue == 0) || (__hideUnusedFX.floatValue == 1 && ntAllZooms))
            {
                Texture2D zoomTab = Resources.Load<Texture2D>(zoomImage);
                allzoomsClick = Foldout(zoomTab, allzoomsClick, tabSize);
                if (allzoomsClick)
                {
                    EditorGUILayout.Space();
                    ...
                    //zoom help
                    EditorGUILayout.Space();
                    zoomhelpClick = SubmenuFoldout("Ahh! Which zoom!!?", zoomhelpClick);
                    if (zoomhelpClick)
                    {
                        EditorGUILayout.Space();
                        generateMessage("\nstill a bit confusing, buuut quick guide:\n" +
            ...
            //new tab systems: misc (moved to end)
            Texture2D miscTab = Resources.Load<Texture2D>(miscImage);
            newtabMiscClick = Foldout(miscTab, newtabMiscClick, tabSize);
            if (newtabMiscClick)
            {
                EditorGUILayout.Space();
                if ((__hideUnusedFX.floatValue == 0) || (__hideUnusedFX.floatValue == 1 && ntAscii))
                {
                    asciiClick = SubmenuFoldout(propStyles.Ascii.text, asciiClick);
                    if (asciiClick)
                    {
                        EditorGUILayout.Space();
                ...
                {
                    colorsplitClick = SubmenuFoldout(propStyles.ColorSplit.text, colorsplitClick);
                    if (colorsplitClick)
                    {
                        EditorGUILayout.Space();
                ...
                {
                    edgeDistortClick = SubmenuFoldout(propStyles.Ascii.text, edgeDistortClick);
                    if (edgeDistortClick)
                    {
                        EditorGUILayout.Space();
                ...
                {
                    fadeprojectionClick = SubmenuFoldout(propStyles.Fade.text, fadeprojectionClick);
                ...
                {
                    inceptionClick = SubmenuFoldout(propStyles.Inceptions.text, inceptionClick);
                    if (inceptionClick)
                    {
                        EditorGUILayout.Space();
                ...
                {
                    multiscreenClick = SubmenuFoldout(propStyles.MultipleScreen.text, multiscreenClick);
                    if (multiscreenClick)
                    {
                        EditorGUILayout.Space();
                ...
                {
                    rgbzoomClick = SubmenuFoldout(propStyles.RGBZoom.text, rgbzoomClick);
                    if (rgbzoomClick)
                    {
                        EditorGUILayout.Space();
                        EditorGUILayout.Space();
                ...
                {
                    smearClick = SubmenuFoldout(propStyles.Smear.text, smearClick);
                    if (smearClick)
                    {
                        EditorGUILayout.Space();
                ...
                {
                    silhouetteClick = SubmenuFoldout(propStyles.Silhouette.text, silhouetteClick);
                    if (silhouetteClick)
                    {
                        EditorGUILayout.Space();
                ...
                {
                    visualizerClick = SubmenuFoldout(propStyles.Visualizer.text, visualizerClick);
                    if (visualizerClick)
                    {
                        EditorGUILayout.Space();
                        EditorGUILayout.Space();
            ...
            //animating // tools now
            Texture2D animateTab = Resources.Load<Texture2D>(toolsImage);
            animateClick = Foldout(animateTab, animateClick, tabSize);
            if (animateClick)
            {
                EditorGUILayout.Space();
                EditorGUILayout.Space();
                ...
                generateMessage("Use this on the \"type\" mode on GVAS scripts.", fakePropertyStyle);
                EditorGUILayout.Space();
                EditorGUILayout.Space();
                EditorGUILayout.Space();
                gifColumns = EditorGUILayout.TextField("Gif Columns: ", gifColumns);
                int columnsInInt = 0;
                try
                {
                    columnsInInt = Int32.Parse(gifColumns);
                }
                catch (Exception e)
                {
                    //o well lol
                ...
                EditorGUILayout.BeginHorizontal();
                gifSrc = EditorGUILayout.TextField("GIF Source: ", gifSrc);
                if (GUILayout.Button("Browse")){
                    string path = EditorUtility.OpenFilePanel("Overwrite with gif", "", "gif");
                    if (path.Length != 0)
                    {
                        gifSrc = path;
                    }
                ...
                EditorGUILayout.EndHorizontal();
                EditorGUILayout.BeginHorizontal();
                gifSave = EditorGUILayout.TextField("Save Folder: ", gifSave);
                if (GUILayout.Button("Browse")){
                ...
                EditorGUILayout.EndHorizontal();
                EditorGUILayout.BeginHorizontal();
                gifName = EditorGUILayout.TextField("Spritesheet Name: ", gifName);
                generateMessage(".png", fakePropertyStyle);
                EditorGUILayout.EndHorizontal();
                if (GUILayout.Button("gif to spritesheet"))
                {
                    try
                    {
                        columnsInInt = Int32.Parse(gifColumns);
                    ...
                    Image gif = Image.FromFile(gifSrc);
                    List<Image> IMGs = new List<Image>();
                    int Length = gif.GetFrameCount(System.Drawing.Imaging.FrameDimension.Time);
                    ...
                    Image[] gifFrames = IMGs.ToArray();

                    int rowsToInt = (int)Math.Ceiling((double)gifFrames.Length / 10);

                    using (Bitmap bitmap = new Bitmap(gifFrames[0].Width * 10, gifFrames[0].Height * rowsToInt))
                    {
                        using (System.Drawing.Graphics graphics = System.Drawing.Graphics.FromImage(bitmap))
                        {
                            for (int i = 0; i < gifFrames.Length; ++i)
                            {
                                Image image = gifFrames[i];

                                graphics.DrawImage(
                                    image,
                                    image.Width * (i % 10),
                                    image.Height * (int)((double)i / 10)
                                );
                            }
                        }

                        bitmap.Save(gifSave + Path.DirectorySeparatorChar + columnsInInt.ToString() + "Col x " + rowsToInt.ToString() + "Row " + gifName + ".png");
                        #if UNITY_EDITOR
                            UnityEditor.AssetDatabase.Refresh();
                        #endif
                        EditorUtility.DisplayDialog("luka mae.shader", "Your gif conversion is complete!\nDimensions:\nColumns: " + columnsInInt + "\nRows: " + rowsToInt, "okay, cool");
                    }
                ...
                generateMessage("Credits for some of conversion code to jspcal/script ing on StackOverflow.", fakePropertyStyle);
                EditorGUILayout.Space();
                EditorGUILayout.Space();
            }
            ...
            if (__hideUnusedFX.floatValue == 0 && menuUgly == false)
            {
                Texture2D helpTab = Resources.Load<Texture2D>(helpImage);
                helpClick = Foldout(helpTab, helpClick, tabSize);
                if (helpClick)
                {

                    EditorGUILayout.Space();
                    EditorGUILayout.Space();
                    generateMessage("Questions", helpInfoStyle);
                    EditorGUILayout.Space();
                    ...
                    drawDivider();
                    EditorGUILayout.Space();
                    generateMessage("Thanks", helpInfoStyle);
                    EditorGUILayout.Space();
                    //donators menu
                    ...
                    if (acknowledgesmentClick)
                    {
                        ...
                        "shaders have an incredible learning barrier.\n" +
                        ...
                        "thank you for understanding, and please do\n" +
                        "check out and support these other people.\n" +
                        "<3", friendStyle);
                        EditorGUILayout.Space();
                        EditorGUILayout.Space();
                        ...
                        generateMessage(redHeart + "clip shader for like one line of vhs math" + redHeart, friendStyle);
                        ...
                        generateMessage(redHeart + "remade a film shader from github thats been spread everywhere" + redHeart, friendStyle);
                        generateMessage(redHeart + "so i am unsure of the source" + redHeart, friendStyle);
                        ...
                        generateMessage(redHeart + "based noise for artifacts on 'mpeg artifacts' by kusma" + redHeart, friendStyle);
                        generateMessage(redHeart + "DocMe (indirectly Uncomfy) for help with VR" + redHeart, friendStyle);
                        generateMessage(redHeart + "The character Nadeshiko Kagamihara is property of Afro, pub. by Houbunsha." + redHeart, friendStyle);
            ...
            //Settings 
            Texture2D settingsTab = Resources.Load<Texture2D>(settingsImage);
            settingsClick = Foldout(settingsTab, settingsClick, tabSize);
            if (settingsClick)
            {
                EditorGUILayout.Space();
            ...
            if (GUILayout.Button("Apply Preset"))
            {
                switch (selectedPreset)
                {
                    ...
                    case 5:
                        ...
                        targetMat.SetColor("_ColorRGB", UnityEngine.Color.green);
                        break;
                    case 6:
                        _BlinkStrength.floatValue = (float)0.601;
                        targetMat.SetColor("_BlinkColor", UnityEngine.Color.black);
            ...
            //themes
            EditorGUILayout.BeginHorizontal();
            selectedTheme = EditorGUILayout.Popup("Themes", selectedTheme, themeOption);
            ...
            //generateMessage("mae", friendStyle);
            // generateMessage(shaderVersionNumber + versionNumber, friendStyle);
            //enerateMessage("presented by luka#8375", friendStyle);
            generateMessage("release " + shaderVersionNumber + versionNumber, newStyle);
            generateMessage(rainbowfy("the rainbow update"), newStyle);
            //generateMessage("luka's mega after effects", friendStyle);
            EditorGUILayout.Space();
            EditorGUILayout.Space();
            ...
            generateMessage("shader id: " + fontCache, friendStyle);
            try
            {
                generateMessage("your name: " + EditorPrefs.GetString("sdk#username"), friendStyle);
            }catch(Exception e)
            {
                Debug.Log("lukasong / issue getting vrchat username. sdk installed?");
            }
            generateMessage("<b>luka#8375</b>", friendStyle);
